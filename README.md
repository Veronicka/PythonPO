# PythonPO
Estudos de Programação Orientada a Objetos em Python do curso do Luiz Otávio Miranda.

# Conceitos
Associação - Usa | Agregação - Tem | Composição - É dono | Herança - É outro objeto

# Curiosidades sobre convenções de nomes
Convenções de nomes são usadas em variáveis, funções, classes e assim por diante. Essas convenções tem um nome que podemos usar para nos referir ao modo como estamos nomeando determinados objetos em nosso programa: PascalCase, camelCase e snake_case.
